...
### T-028: Backend — Photo Upload Handler for Attendance Evidence
...
### T-029: Frontend — Check-in Page (Location + Camera + Photo Capture/Upload)
...
### T-031: Frontend — Check-out Page (Location + Camera + Photo Capture/Upload)
