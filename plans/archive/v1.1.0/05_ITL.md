...
- **Status:** [x]
- **FSD Ref:**
  - §2.6.2 Functional Requirements — Upload Face Photo
- **TDD Ref:**
  - POST /api/upload
...
### T-024: Backend — Upload Face Photo + Face Embedding Generation

- **Feature/Module:** Face Photo
- **Priority:** P0
- **Estimated Effort:** 4h
- **Status:** [ ]
- **FSD Ref:**
...
### T-025: Frontend — Face Photo Capture/Upload Component
...
### T-026: Backend — Face Recognition Service (GoCV/face-recognition-go)
...
- **Status:** [ ]
- **FSD Ref:**
  - §2.2.1 Functional Requirements — Check-in (Geotagging + Face Recognition)
- **TDD Ref:**
  - Service layer (Face Recognition Service)

### T-027: Backend — Check-in Geotagging + Haversine Validation
...
### T-028: Backend — Check-in with Face Recognition Match
...
### T-029: Frontend — Check-in Page (Location + Camera + Capture)
...
- **FSD Ref:**
  - §2.2.1 Functional Requirements — Check-in (Geotagging + Face Recognition)
  - §3.5 User Interaction — Attendance Check-in (Geotagging)
  - §5.1 Feature Logic Flow — Check-in (Geotagging + Face Recognition) Flow
- **TDD Ref:**
  - POST /api/attendance/checkin

### T-030: Backend — Check-out Geotagging + Duration Calculation
...
- **Status:** [ ]
- **FSD Ref:**
  - §2.2.3 Functional Requirements — Check-out (Geotagging + Face Recognition)
- **TDD Ref:**
  - POST /api/attendance/checkout

### T-031: Backend — Check-out with Optional Face Recognition
...
### T-032: Frontend — Check-out Page (Location + Camera + Capture)
