...
- **Business Logic:**
  ...
  - Jika foto gagal diupload, tampilkan error "Gagal mengupload foto. Pastikan koneksi internet stabil"
...
flowchart TD
    ...
    J --> K{"Foto valid?"}
    K -->|"Tidak"| L["Tampilkan error: Gagal upload foto"]
    K -->|"Ya"| M["Simpan record absensi + foto evidence"]
    M --> N["Tampilkan success message"]
