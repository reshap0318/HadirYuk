...
| Endpoint | Method | Auth | Permission | Request Payload | Success Response |
|----------|--------|------|------------|-----------------|------------------|
| `/api/shifts` | POST | ✅ | `shift.create` | `{ "name": "string", "start_time": "08:00", "end_time": "17:00", "break_duration": 60, "flexi_minutes": 15, "color_code": "#FF0000" }` | `{ "code": 201, "message": "...", "data": { "id": 1, ... } }` |
...
| Endpoint | Method | Auth | Permission | Request Payload | Success Response |
|----------|--------|------|------------|-----------------|------------------|
| `/api/users` | POST | ✅ | `user.create` | `{ "name": "string", "email": "string", "phone": "string", "department": "string", "position": "string" }` | `{ "code": 201, "message": "...", "data": { "id": 1, ... } }` |
...
| `/api/users/:id` | PUT | ✅ | `user.update` | `{ "name": "string", "phone": "string", "department": "string", "position": "string", "roles": [1, 2] }` | `{ "code": 200, "message": "...", "data": { "id": 1, ... } }` |
...
| `/api/roles/:id` | PUT | ✅ | `role.update` | `{ "name": "string", "description": "string", "permissions": [1, 2, 3] }` | `{ "code": 200, "message": "...", "data": { "id": 1, ... } }` |
...
| `role.update` | PUT /api/roles/:id (accepts `permissions` array inline) |
